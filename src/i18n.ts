...
const strings = {
  ru: {
    ...
    optionLosslessDesc: 'Умное сжатие — визуально не отличить от оригинала (уровень TinyPNG)',
    ...
    convertCompressTitle: 'Сжимать при конвертации?',
    convertCompressPlaceholder: 'Сжать изображение во время смены формата?',
    convertCompressYes: 'Да, сжать',
    convertCompressYesDesc: 'Выбрать уровень сжатия (lossless / 90% / 80% / custom)',
    convertCompressNo: 'Нет, оставить как есть',
    convertCompressNoDesc: 'Только сменить формат — без потери пикселей',
    convertQualityTitle: 'Уровень сжатия',
    convertQualityPlaceholder: 'Выберите уровень сжатия для нового формата',
    ...
    toolDetail: {
      ...
      oxipng:   'Рекомендуется. Дополнительная lossless-оптимизация PNG после pngquant — выигрыш ещё 5–15% размера, как у TinyPNG.',
  ...
  en: {
    ...
    optionLosslessDesc: 'Smart compression — visually identical to the original (TinyPNG-level)',
    ...
    convertCompressTitle: 'Compress during conversion?',
    convertCompressPlaceholder: 'Should the image be compressed while changing format?',
    convertCompressYes: 'Yes, compress',
    convertCompressYesDesc: 'Pick a compression level (lossless / 90% / 80% / custom)',
    convertCompressNo: 'No, keep as is',
    convertCompressNoDesc: 'Change format only — pixel-perfect, no compression',
    convertQualityTitle: 'Compression level',
    convertQualityPlaceholder: 'Pick a compression level for the new format',
    ...
    toolDetail: {
      ...
      oxipng:   'Recommended. Additional lossless PNG post-optimization after pngquant — saves another 5–15%, on par with TinyPNG.',
